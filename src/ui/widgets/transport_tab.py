...
class TransportTab(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.rows: list[FrequencyRow] = [
            FrequencyRow(text = "Transportes públicos", parent = self),
            FrequencyRow(text = "Combustível", parent = self),
            FrequencyRow(text = "Estacionamento", parent = self),
            FrequencyRow(text = "Manutenção do automóvel", parent = self),
            FrequencyRow(text = "Portagens", parent = self),
